...
const QuestionarioManagement = () => {
  ...
  const handleSalvar = async () => {
    ...
    try {
      ...
      if (id) {
        ...
        navigate('/qualidade/questionarios');
      }
    } catch (err) {
  ...
  const handleDuplicarComoNovo = () => {
    navigate('/qualidade/questionarios/criar', { state: { duplicarDe: id } });
  };
    ...
    <div className="container mx-auto p-6 max-w-6xl">
      ...
      <div className="bg-white rounded-2xl shadow-xl p-10 space-y-10">
        ...
        <div className="flex justify-between items-center pt-10 border-t-4 border-gray-200">
          <button
            type="button"
            onClick={() => navigate('/qualidade/questionarios')}
...
export default QuestionarioManagement;
