...
import { fetchStudentDossierGrades } from '../../utils/api';

const DossierGradeDetailsPage = () => {
    ...
    useEffect(() => {
        if (studentId && dossierId) {
            ...
            setError('Student ID or Dossier ID not found.');
            setLoading(false);
        }
    }, [studentId, dossierId]);
            ...
            <div className="max-w-7xl mx-auto px-6 py-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    ...
                    <div className="bg-white rounded-lg p-4 border border-gray-200">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-gray-500 font-medium">Instrumentos</p>
                ...
                <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg mb-6">
                    <div className="flex items-start">
                        ...
                        <div className="text-sm text-blue-700">
                            <p className="font-semibold mb-1">Como é calculada a sua nota?</p>
                            <p>Cada instrumento contribui proporcionalmente ao seu peso dentro do critério. A classificação final é a soma ponderada de todos os critérios.</p>
                        </div>
                    </div>
                </div>
...
export default DossierGradeDetailsPage;
